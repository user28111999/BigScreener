...
import TorrentSearch from "./utils/torrent-search";
import SubtitleSearch from "./utils/subtitle-search";
...
class App extends Component {
    ...
    applyTimeout = (type) => {
        ...
        if (!type) {
            message = "Ooops, something went wrong. Please try a different torrent.";
        } else if (type == 1) {
            message = `We can't your movie`;
        } else if (type == 2) {
    ...
    streamTorrent = (movie) => {
        ...
        this.setStreaming();
        this.setStreamTimeout(20000);
        this.setPlayerStatus("Initializing...", true);
        ...
        if (this.state.playMovie) {
            ...
            torrent.on("metadata", () => {
                ...
                this.setPlayerStatus("Getting Metadata", true);
            });

            torrent.on("ready", () => {
                this.setFileLoadedTimeout();
                this.setPlayerStatus("Almost ready", true);
                ...
                if (!file) {
                    ...
                    this
                        .fetchFirstPieces(torrent, file)
                        .then(() => {
                            this.setPlayerStatus("Logging in", true);
                            this.setMovieTime();
    ...
    searchTorrent = (movie, show, excludeDate) => {
        ...
        if (movie.magnet) {
            ...
            if (this.state.playMovie) {
                ...
                this.setPlayerStatus(`Looking for "${movie.show_title || movie.title}"`, true);
    ...
    loadCategories = (shows) => {
        let movieGenres = require('./models/movie-genres');
        movieGenres = shows
    ...
    startFireBase = () => {
        let firebaseConfig = {
            apiKey: "AIzaSyA8i6_dcJsRAQzbDe8vMktIP7zJFdhLU8I",
            authDomain: "bigscreener-40787.firebaseapp.com",
            databaseURL: "https://bigscreener-40787.firebaseio.com",
            projectId: "bigscreener-40787",
            storageBucket: "bigscreener-40787.appspot.com",
            messagingSenderId: "134375469671",
            appId: "1:134375469671:web:3348cc5883124d2a"       
        };
