            ...
            .then((response) => {
                ...
                if (episodes) {
                    for (let i = 0; i < episodes.length; i++) {
                        ...
                        appEpisodes.push(newEpisode);
                    }

                    return {name: season.name, number: season.season_number, episodes: appEpisodes}
                }
            })
        ...
        return (
            <div
                    ...
                    <div className='movie-modal-info'>
                        <div className="movie-modal-poster-info">
                            <div
                                ...
                                style={{
                                backgroundImage: `url(${movie.app_data.poster_path})`
                            }}></div>
                        </div>
                ...
                <div
                    ...
                    style={{
                    backgroundImage: `url(${movie.app_data.blurry_backdrop_path})`
                }}/>
                <div
