    ...
    render() {
        ...
        return (
            <div className='app-header'>
                <Fade spy={this.props.background} distance='0%' bottom>
                    <div
                ...
                <div className='app-header-bg'>
                    <Fade spy={this.props.user ? this.props.user.email : this.props.user} distance='10%' cascade bottom>
                        <div className='app-header-title'>
                            <div>{`BigScreener Beta v${version} ·`}</div>
                    ...
                    <Fade spy={this.props.subtitle} distance='0%' cascade bottom>
