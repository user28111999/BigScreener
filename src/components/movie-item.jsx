...
class MovieItem extends Component {
    ...
    loadImage = () => {
        if (!this.unMounting) {
            this.setState({
                backdrop: `${this.props.shows ? this.props.movie.app_data.series_backdrop_path : this.props.fallback
                    ? this.props.movie.app_data.backdrop_path
                    : this.props.movie.app_data.poster_path}`
            });
        }
    };
    ...
    handleImage = () => {
        let posterImage = this.createNewImage(this.props.movie.app_data.poster_path);
        let colorImage = this.createNewImage(this.props.movie.app_data.blurry_backdrop_path);
        ...
        if (this.props.fallback) {
            let backdropImage = this.createNewImage(this.props.movie.app_data.backdrop_path);
            ...
            <Fade distance='10%' bottom>
                <div className='movie-item' onClick={this.handleMovieClick}>
                    ...
                    <img
                        ...
                        ? this.props.movie.app_data.blurry_backdrop_path
                        : this.props.movie.app_data.blurry_poster_path}
